module github.com/themakers/pastor

go 1.24.4

// FIXME: wait for deps to update
replace sigs.k8s.io/controller-runtime v0.21.0 => sigs.k8s.io/controller-runtime v0.21.1-0.20250728190028-ea7a2e250f8b

require (
	github.com/mikefarah/yq/v4 v4.47.1
	github.com/samber/lo v1.51.0
	gopkg.in/yaml.v3 v3.0.1
	helm.sh/helm/v4 v4.0.0-20250725180632-5ab8e26c9ffe
